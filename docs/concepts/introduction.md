...
![Static structure diagrams](../assets/c4-diagram-types.png)
...
|-----------------------------------------------------------------------|-------------------------------------------------------------|-------------------------------------------------------------|
| ![system context](../assets/introduction/system-context.png)             | ![container diagram](../assets/introduction/container.png)     | ![component diagram](../assets/introduction/component.png)     |
