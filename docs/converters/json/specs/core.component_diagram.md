...
> **Source:** [core.component-diagram.json](../../../assets/specs/core.component-diagram.json)


This schema describes the [ComponentDiagram][c4.diagrams.component.ComponentDiagram] spec for the Core backend.
...
??? abstract "Examples"
    ...
    === "Minimal"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/core/component-diagram.minimal.json"
            ```
    ...
    === "Advanced"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/core/component-diagram.advanced.json"
            ```
