...
> **Source:** [plantuml.system-context-diagram.json](../../../assets/specs/plantuml.system-context-diagram.json)


This schema describes the [SystemContextDiagram][c4.diagrams.system_context.SystemContextDiagram] spec for the PlantUML backend.
...
??? abstract "Examples"
    ...
    === "Minimal"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/plantuml/system-context-diagram.minimal.json"
            ```

        ??? example "Rendered PlantUML source"

            ```puml
            --8<-- "assets/examples/plantuml/system-context-diagram.minimal.puml"
            ```

        ??? example "Rendered image"

            <figure markdown="span">
            ![SystemContextDiagram minimal example](../../../assets/examples/plantuml/system-context-diagram.minimal.png)
            </figure>
    ...
    === "Advanced"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/plantuml/system-context-diagram.advanced.json"
            ```

        ??? example "Rendered PlantUML source"

            ```puml
            --8<-- "assets/examples/plantuml/system-context-diagram.advanced.puml"
            ```

        ??? example "Rendered image"

            <figure markdown="span">
            ![SystemContextDiagram advanced example](../../../assets/examples/plantuml/system-context-diagram.advanced.png)
            </figure>
