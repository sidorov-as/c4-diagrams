# Core SystemLandscapeDiagram Spec

> **Source:** [core.system-landscape-diagram.json](../../../assets/specs/core.system-landscape-diagram.json)


This schema describes the [SystemLandscapeDiagram][c4.diagrams.system_context.SystemLandscapeDiagram] spec for the Core backend.
...
??? abstract "Examples"
    ...
    === "Minimal"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/core/system-landscape-diagram.minimal.json"
            ```
    ...
    === "Advanced"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/core/system-landscape-diagram.advanced.json"
            ```
