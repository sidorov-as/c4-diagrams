# PlantUML DeploymentDiagram Spec

> **Source:** [plantuml.deployment-diagram.json](../../../assets/specs/plantuml.deployment-diagram.json)


This schema describes the [DeploymentDiagram][c4.diagrams.deployment.DeploymentDiagram] spec for the PlantUML backend.
...
??? abstract "Examples"
    ...
    === "Minimal"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/plantuml/deployment-diagram.minimal.json"
            ```

        ??? example "Rendered PlantUML source"

            ```puml
            --8<-- "assets/examples/plantuml/deployment-diagram.minimal.puml"
            ```

        ??? example "Rendered image"

            <figure markdown="span">
            ![DeploymentDiagram minimal example](../../../assets/examples/plantuml/deployment-diagram.minimal.png)
            </figure>
    ...
    === "Advanced"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/plantuml/deployment-diagram.advanced.json"
            ```

        ??? example "Rendered PlantUML source"

            ```puml
            --8<-- "assets/examples/plantuml/deployment-diagram.advanced.puml"
            ```

        ??? example "Rendered image"

            <figure markdown="span">
            ![DeploymentDiagram advanced example](../../../assets/examples/plantuml/deployment-diagram.advanced.png)
            </figure>
...
- [PlantUMLNodeSchema](#plantumlnodeschema)
- [PlantUMLNodeLeftSchema](#plantumlnodeleftschema)
- [PlantUMLNodeRightSchema](#plantumlnoderightschema)
- [PlantUMLDeploymentNodeSchema](#plantumldeploymentnodeschema)
- [PlantUMLDeploymentNodeLeftSchema](#plantumldeploymentnodeleftschema)
- [PlantUMLDeploymentNodeRightSchema](#plantumldeploymentnoderightschema)
