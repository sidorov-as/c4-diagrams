# PlantUML ContainerDiagram Spec

> **Source:** [plantuml.container-diagram.json](../../../assets/specs/plantuml.container-diagram.json)


This schema describes the [ContainerDiagram][c4.diagrams.container.ContainerDiagram] spec for the PlantUML backend.
...
??? abstract "Examples"
    ...
    === "Minimal"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/plantuml/container-diagram.minimal.json"
            ```

        ??? example "Rendered PlantUML source"

            ```puml
            --8<-- "assets/examples/plantuml/container-diagram.minimal.puml"
            ```

        ??? example "Rendered image"

            <figure markdown="span">
            ![ContainerDiagram minimal example](../../../assets/examples/plantuml/container-diagram.minimal.png)
            </figure>
    ...
    === "Advanced"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/plantuml/container-diagram.advanced.json"
            ```

        ??? example "Rendered PlantUML source"

            ```puml
            --8<-- "assets/examples/plantuml/container-diagram.advanced.puml"
            ```

        ??? example "Rendered image"

            <figure markdown="span">
            ![ContainerDiagram advanced example](../../../assets/examples/plantuml/container-diagram.advanced.png)
            </figure>
...
- [PlantUMLContainerBoundarySchema](#plantumlcontainerboundaryschema)
- [PlantUMLContainerEnterpriseBoundarySchema](#plantumlcontainerenterpriseboundaryschema)
- [PlantUMLContainerSystemBoundarySchema](#plantumlcontainersystemboundaryschema)
