# PlantUML DynamicDiagram Spec

> **Source:** [plantuml.dynamic-diagram.json](../../../assets/specs/plantuml.dynamic-diagram.json)


This schema describes the [DynamicDiagram][c4.diagrams.dynamic.DynamicDiagram] spec for the PlantUML backend.
...
???+ info "Properties"
    ...
    | `steps` | <code>array[<code><a href="#plantumlrelationshipschema">PlantUMLRelationshipSchema</a></code>\|<code><a href="#incrementschema">IncrementSchema</a></code>\|<code><a href="#setindexschema">SetIndexSchema</a></code>]</code> | Dynamic diagram steps. |
...
??? abstract "Examples"
    ...
    === "Minimal"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/plantuml/dynamic-diagram.minimal.json"
            ```

        ??? example "Rendered PlantUML source"

            ```puml
            --8<-- "assets/examples/plantuml/dynamic-diagram.minimal.puml"
            ```

        ??? example "Rendered image"

            <figure markdown="span">
            ![DynamicDiagram minimal example](../../../assets/examples/plantuml/dynamic-diagram.minimal.png)
            </figure>
    ...
    === "Advanced"
        ...
        ??? example "JSON source"
            ...
            ```json
            --8<-- "assets/examples/json/plantuml/dynamic-diagram.advanced.json"
            ```

        ??? example "Rendered PlantUML source"

            ```puml
            --8<-- "assets/examples/plantuml/dynamic-diagram.advanced.puml"
            ```

        ??? example "Rendered image"

            <figure markdown="span">
            ![DynamicDiagram advanced example](../../../assets/examples/plantuml/dynamic-diagram.advanced.png)
            </figure>
...
- [PlantUMLContainerSchema](#plantumlcontainerschema)
- [PlantUMLContainerExtSchema](#plantumlcontainerextschema)
- [PlantUMLContainerDbSchema](#plantumlcontainerdbschema)
- [PlantUMLContainerDbExtSchema](#plantumlcontainerdbextschema)
- [PlantUMLContainerQueueSchema](#plantumlcontainerqueueschema)
- [PlantUMLContainerQueueExtSchema](#plantumlcontainerqueueextschema)
- [PlantUMLComponentSchema](#plantumlcomponentschema)
- [PlantUMLComponentExtSchema](#plantumlcomponentextschema)
- [PlantUMLComponentDbSchema](#plantumlcomponentdbschema)
- [PlantUMLComponentDbExtSchema](#plantumlcomponentdbextschema)
- [PlantUMLComponentQueueSchema](#plantumlcomponentqueueschema)
- [PlantUMLComponentQueueExtSchema](#plantumlcomponentqueueextschema)

### Boundaries

- [PlantUMLDynamicBoundarySchema](#plantumldynamicboundaryschema)
- [PlantUMLDynamicEnterpriseBoundarySchema](#plantumldynamicenterpriseboundaryschema)
- [PlantUMLDynamicSystemBoundarySchema](#plantumldynamicsystemboundaryschema)
- [PlantUMLDynamicContainerBoundarySchema](#plantumldynamiccontainerboundaryschema)
...
???+ info "Properties"
    ...
    | `offset` | <span style="white-space: nowrap;">`integer` \| `null`</span> | The amount to increment the index by. Default: `1`. |
