...
class WithType:
    """Mixin for schemas that expose a custom type/stereotype field."""
...
class BoundaryTagSchema(BaseTagSchema, WithType):
    """Tag for diagram boundaries (containers/systems)."""

    __model__: ClassVar[TypeAny] = BoundaryTag

    type: Literal["BoundaryTag"] = Field(
        ...,
        description="Discriminator identifying the element type.",
    )

    bg_color: str | None = Field(
        None, description="Background color of the boundary."
    )
    font_color: str | None = Field(
        None, description="Font color used for boundary labels."
    )
    border_color: str | None = Field(
        None, description="Color of the boundary border."
    )
    shadowing: bool | None = Field(False, description="Shadow style/toggle.")
    shape: TagShape | None = Field(
        None, description="Optional shape macro used for rendering."
    ...
    border_style: LineStyle | None = Field(
        None, description="Boundary border line style macro."
    )
    border_thickness: str | None = Field(
        None, description="Thickness of the boundary border line."
    )
...
class NodeTagSchema(BaseTagSchema, WithType):
    """Tag for nodes (typically infrastructure elements)."""

    __model__: ClassVar[TypeAny] = NodeTag

    type: Literal["NodeTag"] = Field(
        ...,
        description="Discriminator identifying the element type.",
    )

    bg_color: str | None = Field(
        None, description="Background color of the node."
    )
    font_color: str | None = Field(
        None, description="Font color used for node labels."
    )
    border_color: str | None = Field(
        None, description="Color of the node border."
    )
    shadowing: bool | None = Field(False, description="Shadow style/toggle.")
    shape: TagShape | None = Field(
        None, description="Optional shape macro used for rendering."
    ...
    border_style: LineStyle | None = Field(
        None, description="Node border line style macro."
    )
    border_thickness: str | None = Field(
        None, description="Thickness of the node border line."
    )
...
class BoundaryStyleSchema(BaseStyleSchema, WithType):
    """
    ...
    type: Literal["BoundaryStyle"] = Field(
        ...,
        description="Discriminator identifying the element type.",
    )
    ...
    element_name: str | None = Field(
        None,
        description=(
            "Boundary element type to style "
            "(e.g. 'enterprise', 'system', 'container')."
        ),
    )
    bg_color: str | None = Field(None, description="Background color.")
    font_color: str | None = Field(None, description="Font/text color.")
    ...
    sprite: str | None = Field(
        None, description="Sprite icon applied to the boundary."
    )
    legend_text: str | None = Field(
        None, description="Legend label for this styled boundary."
    )
    legend_sprite: str | None = Field(
        None, description="Legend sprite for this styled boundary."
    )
    border_style: LineStyle | None = Field(
        None, description="Border line style macro."
    )
...
class SpecificBoundaryStyleSchema(BaseStyleSchema, WithType):
    """
    Style update for a specific boundary kind.
    """
...
class ContainerBoundaryStyleSchema(SpecificBoundaryStyleSchema):
    """Style update for container boundaries."""

    __model__: ClassVar[TypeAny] = ContainerBoundaryStyle

    type: Literal["ContainerBoundaryStyle"] = Field(
        ...,
        description="Discriminator identifying the element type.",
    )


class SystemBoundaryStyleSchema(SpecificBoundaryStyleSchema):
    """Style update for system boundaries."""

    __model__: ClassVar[TypeAny] = SystemBoundaryStyle

    type: Literal["SystemBoundaryStyle"] = Field(
        ...,
        description="Discriminator identifying the element type.",
    )


class EnterpriseBoundaryStyleSchema(SpecificBoundaryStyleSchema):
    """Style update for enterprise boundaries."""

    __model__: ClassVar[TypeAny] = EnterpriseBoundaryStyle

    type: Literal["EnterpriseBoundaryStyle"] = Field(
        ...,
        description="Discriminator identifying the element type.",
    )
